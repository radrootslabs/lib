...
| `RCRV1-DEV-006` | 046-048, 050-053 | Retain the exact non-default Phase 1 publication-readiness/raster extension temporarily while keeping external I/O and application policy forbidden; resolve ownership before publication. |
