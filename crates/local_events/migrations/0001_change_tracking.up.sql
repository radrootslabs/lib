create table local_event_record_next (
...
insert into local_event_record_next(
  seq,
  change_seq,
  record_id,
  family,
...
alter table local_event_record_next rename to local_event_record;
...
create table local_event_projection_cursor_next (
...
insert into local_event_projection_cursor_next(
  consumer_id,
  last_change_seq,
  updated_at_ms
)
...
alter table local_event_projection_cursor_next rename to local_event_projection_cursor;
