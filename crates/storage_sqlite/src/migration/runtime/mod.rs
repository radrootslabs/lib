...
pub const MIGRATIONS: &[MigrationDescriptor] = &[
    ...
    MigrationDescriptor {
        version: 12,
        name: "materialized_projection_documents",
    ...
    MigrationDescriptor {
        version: 14,
        name: "authored_draft_query_metadata",
...
mod tests {
    ...
    fn embedded_migration_checksum_is_pinned() {
        ...
        assert_eq!(migration_sql(CURRENT_VERSION + 1), None);
    }
