...
pub struct RadrootsKnowledgeContractManifest {
    ...
    pub radroots_events_version: String,
    pub radroots_events_codec_version: String,
...
pub fn knowledge_contract_manifest() -> RadrootsKnowledgeContractManifest {
    ...
    RadrootsKnowledgeContractManifest {
        ...
        radroots_events_version: RADROOTS_EVENTS_VERSION.to_string(),
        radroots_events_codec_version: env!("CARGO_PKG_VERSION").to_string(),
...
fn reducer_label(value: RadrootsReducer) -> &'static str {
    match value {
        ...
        RadrootsReducer::RelayPolicyProjection => "relay_policy_projection",
