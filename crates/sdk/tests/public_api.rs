...
fn public_native_type_snapshot_uses_contextual_names() {
    let actual = BTreeSet::from([
        ...
        type_name::<radroots_sdk::signing::Operations<'static>>(),
        type_name::<radroots_sdk::signing::Provider>(),
        type_name::<radroots_sdk::signing::BlossomAuthorizationPlan>(),
    ...
    let actual = actual
        .into_iter()
        .chain([
            type_name::<radroots_sdk::signing::AuthorizationHeader>(),
