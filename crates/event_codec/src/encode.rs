...
pub mod rhi {
    pub use crate::rhi::{
        RADROOTS_RHI_EVIDENCE_ATTESTATION_CONTRACT_ID,
        RADROOTS_RHI_EVIDENCE_ATTESTATION_MAXIMUM_BYTES, RadrootsRhiEvidenceAttestationError,
        RadrootsRhiEvidenceAttestationV1, rhi_evidence_attestation_event_build,
