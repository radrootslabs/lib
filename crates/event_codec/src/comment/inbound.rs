...
mod tests {
    ...
    fn enforces_inbound_structural_tag_limits_exactly() {
        ...
        assert_eq!(
            project_nip22_comment_parts(KIND_COMMENT, &overflow_tag_count, "Comment", 10)
                .unwrap_err(),
        ...
        let supplemental_tag_count =
            RADROOTS_NIP22_COMMENT_TAG_MAX_COUNT - exact_element_count.len();
