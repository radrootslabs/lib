...
fn validate_recipient(recipient: &GiftWrapRecipient) -> Result<Vec<String>, EventEncodeError> {
...
pub fn gift_wrap_build_tags(gift_wrap: &GiftWrap) -> Result<Vec<Vec<String>>, EventEncodeError> {
...
pub fn to_wire_parts(gift_wrap: &GiftWrap) -> Result<Nip01EventWireParts, EventEncodeError> {
