//! Frozen NIP-10 reply semantics for event-contract registry v7.
...
pub fn project_verified_nip10_reply_event(
    ...
    project_verified_nip10_reply_event_registry_v7(verified_event)
}

/// Projects a verified NIP-10 reply with contract-registry-v7 semantics.
pub fn project_verified_nip10_reply_event_registry_v7(
    verified_event: &RadrootsSignatureVerifiedEvent,
) -> Result<RadrootsInboundNip10ReplyProjection, RadrootsNip10ReplyProjectionError> {
