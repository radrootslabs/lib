...
use super::{
    ...
    apply_reconciliation_hook, validate_applied_hook_state,
};
...
async fn nip09_reconciliation_v1_result_vector() {
    ...
    let vector: Nip09ReconciliationVector =
        serde_json::from_slice(RESULT_VECTOR_BYTES).expect("strict NIP-09 reconciliation vector");
