...
const EVENT_BINDINGS_TYPES_TS: &str =
    include_str!("../../../../crates/event_bindings/tests/fixtures/generated_types.ts");
...
mod tests {
    ...
    const CORE_BINDINGS_TYPES_TS: &str =
        include_str!("../../../../crates/core_bindings/tests/fixtures/generated_types.ts");
    const EVENT_BINDINGS_TYPES_TS: &str =
        include_str!("../../../../crates/event_bindings/tests/fixtures/generated_types.ts");
    const REPLICA_SCHEMA_BINDINGS_TYPES_TS: &str = include_str!(
        "../../../../crates/replica_schema_bindings/tests/fixtures/generated_types.ts"
    );
    ...
    const REPLICA_SCHEMA_MODEL_SOURCES: &[&str] = &[
        include_str!("../../../../crates/replica_schema/src/models/farm.rs"),
        include_str!("../../../../crates/replica_schema/src/models/farm_gcs_location.rs"),
        include_str!("../../../../crates/replica_schema/src/models/farm_member.rs"),
        include_str!("../../../../crates/replica_schema/src/models/farm_member_claim.rs"),
        include_str!("../../../../crates/replica_schema/src/models/farm_tag.rs"),
        include_str!("../../../../crates/replica_schema/src/models/gcs_location.rs"),
        include_str!("../../../../crates/replica_schema/src/models/log_error.rs"),
        include_str!("../../../../crates/replica_schema/src/models/media_image.rs"),
        include_str!("../../../../crates/replica_schema/src/models/nostr_event_head.rs"),
        include_str!("../../../../crates/replica_schema/src/models/nostr_profile.rs"),
        include_str!("../../../../crates/replica_schema/src/models/nostr_profile_relay.rs"),
        include_str!("../../../../crates/replica_schema/src/models/nostr_relay.rs"),
        include_str!("../../../../crates/replica_schema/src/models/plot.rs"),
        include_str!("../../../../crates/replica_schema/src/models/plot_gcs_location.rs"),
        include_str!("../../../../crates/replica_schema/src/models/plot_tag.rs"),
        include_str!("../../../../crates/replica_schema/src/models/trade_product.rs"),
        include_str!("../../../../crates/replica_schema/src/models/trade_product_location.rs"),
        include_str!("../../../../crates/replica_schema/src/models/trade_product_media.rs"),
    ];
