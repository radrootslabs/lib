...
mod tests {
    ...
    use crate::sdk_generation::package_matrix::package_specs;
    ...
    const EVENT_BINDINGS_CONSTANTS_TS: &str =
        include_str!("../../../../crates/event_bindings/tests/fixtures/generated_constants.ts");
    const EVENT_BINDINGS_KINDS_TS: &str =
        include_str!("../../../../crates/event_bindings/tests/fixtures/generated_kinds.ts");
    const IDENTITY_BINDINGS_CONSTANTS_TS: &str =
        include_str!("../../../../crates/identity_bindings/tests/fixtures/generated_constants.ts");
