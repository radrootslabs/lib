...
pub(super) const DELETION_OPERATION_EXPECTATIONS: [DeletionOperationExpectation; 4] = [
    ...
    DeletionOperationExpectation {
        ...
        rust_types: &[
            "radroots_event_codec::decode::deletion::RadrootsInboundNip09DeletionAddressTarget",
            "radroots_event_codec::decode::deletion::RadrootsInboundNip09DeletionEventTarget",
            "radroots_event_codec::decode::deletion::RadrootsInboundNip09DeletionKindAdvisory",
            "radroots_event_codec::decode::deletion::RadrootsInboundNip09DeletionProjection",
            "radroots_event_codec::decode::deletion::RadrootsNip09DeletionDiagnostic",
            "radroots_event_codec::decode::deletion::RadrootsNip09DeletionProjectionError",
    ...
    DeletionOperationExpectation {
        ...
        rust_types: &[
            ...
            "radroots_event_codec::admission::deletion::RadrootsAdmittedNip09DeletionRequestEvent",
            "radroots_event_codec::admission::deletion::RadrootsNip09DeletionAdmissionError",
            "radroots_event_codec::decode::deletion::RadrootsInboundNip09DeletionProjection",
            "radroots_event_codec::decode::deletion::RadrootsNip09DeletionProjectionError",
            "radroots_event_codec::verify::RadrootsSignatureVerifiedEvent",
        ],
    ...
    DeletionOperationExpectation {
        ...
        rust_types: &[
            "radroots_event_codec::admission::deletion::RadrootsAdmittedNip09DeletionRequestEvent",
            "radroots_event_codec::admission::deletion::RadrootsNip09AddressReferenceEvidence",
            "radroots_event_codec::admission::deletion::RadrootsNip09EventReferenceEvidence",
            "radroots_event_codec::admission::deletion::RadrootsNip09SuppressionDecision",
            "radroots_event_codec::admission::deletion::RadrootsNip09SuppressionOutcome",
            "radroots_event_codec::admission::deletion::RadrootsNip09SuppressionReason",
            "radroots_event_codec::verify::RadrootsSignatureVerifiedEvent",
        ],
